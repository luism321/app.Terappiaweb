                ...
                <section className="prototype_service_info">
                    ...
                    {userSigui === "Si-no" ?
                        <div className="container">
                            ...
                            <Reveal effect={tipoEstilo} duration={1600}>
                                <div className="col-lg-12 text-center ">
                                    <select className="select " id="borde" Style="width:55%" type="select" name="Pais"
                    ...
                    {userAdo === "SoyAdolecente" ?
                        <div className="container">
                            ...
                            <Reveal effect={tipoEstilo} duration={1600}>
                                <div className="col-lg-12 text-center">
                                    <select className="select " id="borde" Style="width:55%" type="select" onChange={(e) => setuserEdadAdole(e.target.value, e)} onChangeCapture={(e) => onclickAdole('Problemas', e)}  >
                                        <option>Seleccionar</option>
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
