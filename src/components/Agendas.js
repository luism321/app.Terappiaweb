                            ...
                            currentDatosPaDe.map(array => (
                                <div className="card-single">
                                    ...
                                    <div className="card-footer">
                                        <div onClick={() => GoConferenceDataPacient(array.nombres_paciente, array.apellidos_paciente, array.uid_paciente)} className="text-center" id="ini">Iniciar consulta</div>
                                    </div>
                                    <div className="card-footer">
